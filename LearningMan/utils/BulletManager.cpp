...
void BulletManager::manageBulletsWithoutPrint(Controller* shooter, std::list<IAController*>* ennemies, std::vector<sf::Sprite> walls) {
    std::list<Vector2f> :: iterator it;
    std::list<Vector2f> :: iterator itOrigin;
    std::list<IAController*> :: iterator itEnnemies;
    std::list<int> :: iterator itOrientation;
...
void BulletManager::manageBulletsWithoutPrint(Controller* shooter, Controller* ennemies, std::vector<sf::Sprite> walls) {
    std::list<Vector2f> :: iterator it;
    std::list<Vector2f> :: iterator itOrigin;
    std::list<int> :: iterator itOrientation;
    //std::cout << "2 : " << shooter->bullets.size() << " / " << shooter->bulletsOrientation.size() << " / " << shooter->bulletsOrigin.size() << std::endl;
...
void BulletManager::manageBulletsWithoutPrint(Controller* shooter, BossController* ennemies, std::vector<sf::Sprite> walls) {
    std::list<Vector2f> :: iterator it;
    std::list<Vector2f> :: iterator itOrigin;
    std::list<int> :: iterator itOrientation;
